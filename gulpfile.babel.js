...
gulp.task('browserify', () => {
  browserify({
    entries: ['./workspace/assets/scripts/background.js']
  })
    .bundle()
    .pipe(source('./assets/scripts/background.js'))
    .pipe(buffer())
    .pipe(gulp.dest('./dest'));

  browserify({
    entries: ['./workspace/assets/scripts/content.js']
  })
    .bundle()
    .pipe(source('./assets/scripts/content.js'))
    .pipe(buffer())
    .pipe(gulp.dest('./dest'));
});
